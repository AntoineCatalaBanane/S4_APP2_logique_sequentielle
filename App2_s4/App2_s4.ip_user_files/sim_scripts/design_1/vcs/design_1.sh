...
design_libs=(xil_defaultlib xlconstant_v1_1_9 xlconcat_v2_1_6 xlslice_v1_0_4)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/snojiorn/S4_APP2_logique_sequentielle/App2_s4/App2_s4.cache/compile_simlib/vcs"
  fi
