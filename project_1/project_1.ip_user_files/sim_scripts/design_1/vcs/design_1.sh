...
design_libs=(xil_defaultlib xlconstant_v1_1_9 util_vector_logic_v2_0_4 xlconcat_v2_1_6 xlslice_v1_0_4)
...
compile()
{
  ...
  vlogan -work util_vector_logic_v2_0_4 $vlogan_opts +v2k \
